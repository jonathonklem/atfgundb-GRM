    ...
    return (
        <>
            ...
            <form onSubmit={handleSubmit} className="px-4 pb-16">
                ...
                <label className="block my-2 mx-auto"><div className="block text-sm font-extralight tracking-wider">Name</div><div className="block w-full p-2 w-1/2 mx-auto"><input type="text" className="drop-shadow-lg" name="name" /></div></label>
                <label className="block my-2 mx-auto"><div className="block text-sm font-extralight tracking-wider">Manufacturer</div><div className="block w-full p-2 w-1/2 mx-auto"><input type="text" className="drop-shadow-lg" name="manufacturer" /></div></label>
                <label className="block my-2 mx-auto mb-24"><div className="block text-sm font-extralight tracking-wider">Model</div><div className="block w-full p-2 w-1/2 mx-auto"><input type="text" className="drop-shadow-lg" name="model" /></div></label>
