    ...
    return (
        <>
            ...
            <form onSubmit={handleSubmit} className="text-center pb-16">
                ...
                <label className="block my-2 mx-auto text-center"><div className="block w-1/3 mx-auto">Round Count</div><div className="block w-full p-2 w-1/2 mx-auto"><input type="text" name="round_count" /></div></label>
