                    ...
                    <Route 
                        ...
                        element={
                            <div className="">
                                ...
                                <p className="font-extralight opacity-80 mx-auto p-4 block max-w-md tracking-wider text-base">With GunDB, you can effortlessly keep tabs on your ammo purchases, range trips, and gun collection, providing a streamlined approach to firearm management. Easily log details of each ammunition purchase, including quantity, caliber, and date, ensuring you always have an accurate inventory at your fingertips.</p>
                                <Link className="rounded-3xl tracking-wider bg-redbg drop-shadow-lg text-white py-2 px-4 max-w-md w-1/6 block mt-24 mb-36 text-center text-sm mx-auto" to="/preferences">Account Preferences</Link>
                            </div>
                        }
                    ></Route>
