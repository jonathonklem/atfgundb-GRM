    ...
    return (
        <>
            ...
            <form onSubmit={handleSubmit} className="px-4 pb-16">
                ...
                {calculateCpr && (
                    <>
                        <label className="block my-2 mx-auto">
                            ...
                            <div className="block w-full p-2 w-1/2 mx-auto"><input onChange={(e) => setCostOfPurchase(parseFloat(e.target.value))} step="0.01"  type="number" name="price" /></div>
                        </label>
                ...
                {!calculateCpr && (
                    <>
                        <label className="block my-2 mx-auto">
                            ...
                            <div className="block w-full p-2 w-1/2 mx-auto"><input onChange={(e) => setCostPerRound(parseFloat(e.target.value)) } step="0.01" type="number" name="price" /></div>
                        </label>
                ...
                <label className="block my-2 mx-auto mb-24"><div className="block text-sm font-extralight tracking-wider">Quantity</div><div className="block w-full p-2 w-1/2 mx-auto"><input type="number" name="quantity" /></div></label>
